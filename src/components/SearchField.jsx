    ...
    */
    ...
    return (
        <div className={`flex flex-col gap-2 group ${error ? 'error' : ''}`}>
            <div className="min-w-[12.5rem] w-full bg-grey-100 rounded-[1rem] flex gap-4 px-[1.5rem] py-[0.875rem] focus-within:border focus-within:border-purple-500 group-[.error]:border group-[.error]:border-red-500 tablet:py-[1.3125rem]">
                <input value={keyword} onChange={(e) => setKeyword(e.target.value)} aria-label="Search Field" className="grow text-base font-bold text-grey-600 focus:outline-0 tablet:text-lg" placeholder="Search for any word..."/>
